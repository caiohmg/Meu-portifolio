...
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-Z2YCCOME.js";
import {
  createWithBsPrefix
} from "./chunk-BUPJ3XCL.js";
import {
  require_react_dom
...
function useUpdateEffect(fn2, deps) {
  var isFirst = (0, import_react11.useRef)(true);
...
function useUpdatedRef(value) {
  var valueRef = (0, import_react12.useRef)(value);
...
function useTimeout() {
  ...
  var handleRef = (0, import_react14.useRef)();
...
function useSafeState(state) {
  var isMounted = useMounted();
  return [state[0], (0, import_react16.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
var $704cf1d3b684cc5c$var$SSRContext = (0, import_react20.default).createContext($704cf1d3b684cc5c$var$defaultContext);
function $704cf1d3b684cc5c$export$9f8ac96af4b1b2ae(props) {
  let cur = (0, import_react20.useContext)($704cf1d3b684cc5c$var$SSRContext);
  ...
  return (0, import_react20.default).createElement($704cf1d3b684cc5c$var$SSRContext.Provider, {
    value
  }, props.children);
}
...
function $704cf1d3b684cc5c$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react20.useContext)($704cf1d3b684cc5c$var$SSRContext);
...
var Context = (0, import_react23.createContext)(canUseDOM_default ? window : void 0);
var WindowProvider = Context.Provider;
function useWindow() {
  return (0, import_react23.useContext)(Context);
}
...
var Switch = React48.forwardRef((props, ref) => (0, import_jsx_runtime47.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
Image.defaultProps = defaultProps16;
...
function ImperativeTransition({
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react40.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(Component2, runTransition, props) {
  if (Component2) {
    return (0, import_jsx_runtime57.jsx)(Component2, Object.assign({}, props));
  }
  if (runTransition) {
...
var Modal = (0, import_react41.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime58.jsx)("div", Object.assign({}, dialogProps, {
    children: React58.cloneElement(children, {
      role: "document"
    })
  }));
  ...
  return (0, import_jsx_runtime58.jsx)(import_jsx_runtime59.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime60.jsxs)(import_jsx_runtime59.Fragment, {
...
var AbstractModalHeader = React61.forwardRef(({
  closeLabel,
  closeVariant,
  closeButton,
  onHide,
  ...
  const context4 = (0, import_react42.useContext)(ModalContext_default);
...
var Modal2 = React63.forwardRef(({
  ...
  const renderBackdrop = (0, import_react43.useCallback)((backdropProps) => (0, import_jsx_runtime65.jsx)("div", {
    ...backdropProps,
...
var Offcanvas = React69.forwardRef(({
  ...
  const [showOffcanvas, setShowOffcanvas] = (0, import_react48.useState)(false);
...
var Overlay = React73.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react52.useState)(!props.show);
...
function useOverlayOffset(customOffset) {
  ...
  const offset2 = (0, import_react53.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
...
var Overlay2 = React76.forwardRef(({
  ...
  const popperRef = (0, import_react54.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react54.useState)(null);
...
function OverlayTrigger({
  ...
  const triggerNodeRef = (0, import_react55.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout2 = useTimeout();
  const hoverStateRef = (0, import_react55.useRef)("");
  ...
  const handleShow = (0, import_react55.useCallback)(() => {
    timeout2.clear();
  ...
  const handleHide = (0, import_react55.useCallback)(() => {
    timeout2.clear();
  ...
  const handleFocus = (0, import_react55.useCallback)((...args) => {
    handleShow();
    onFocus == null ? void 0 : onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react55.useCallback)((...args) => {
    handleHide();
    onBlur == null ? void 0 : onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react55.useCallback)((...args) => {
    setShow(!show);
    onClick == null ? void 0 : onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react55.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react55.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime83.jsxs)(import_jsx_runtime82.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react55.cloneElement)(children, triggerProps), (0, import_jsx_runtime81.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var ProgressBar = React82.forwardRef(({
  ...
  return (0, import_jsx_runtime89.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react56.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min: min2,
      now,
...
function useTabPanel(_ref) {
  ...
  const context4 = (0, import_react57.useContext)(TabContext_default);
  if (!context4)
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react58.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react58.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var ToastFade = React95.forwardRef((props, ref) => (0, import_jsx_runtime105.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React97.forwardRef(({
  ...
  const context4 = (0, import_react59.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var ToastContainer = React99.forwardRef(({
  ...
  return (0, import_jsx_runtime109.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames64.default)(bsPrefix, position && [containerPosition ? `position-${containerPosition}` : null, positionClasses[position]], className)
  });
});
