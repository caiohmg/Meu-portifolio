    ...
    <>
      <Container>
        <ProjectsContainer>
          <TypeAnimation
            className="text"
            sequence={["Aqui você pode acessar alguns dos meus projetos!"]}
            speed={10}
          ></TypeAnimation>
        </ProjectsContainer>
        <ProjectsContainer>
          <Card>
            ...
            <Card.Body>
              ...
              <p>
                Um cronômetro de tarefas é uma ferramenta muito útil para
                aumentar a produtividade e manter o foco nas atividades do dia a
                dia.
              </p>
            </Card.Body>
            <Button
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <p>
                ...
                objetivo facilitar a vida de quem deseja receber café de
                qualidade diretamente em casa.
              </p>
            </Card.Body>
            <Button
              variant="outline-warning"
        ...
        <Link to="/">
          <Button variant="outline-warning" children="Home" />
        </Link>
        <Link to="../Biography">
          <Button variant="outline-warning" children="Sobre mim" />
        </Link>
      </div>
      </Container>
